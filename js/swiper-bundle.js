      ...
      events: {
        attachEvents: function () {
          ...
          ;(e.onTouchStart = M.bind(e)),
            ...
            (e.onClick = L.bind(e)),
            i.touch && !I && (t.addEventListener("touchstart", A), (I = !0)),
            D(e, "on")
        },
  ...
  const J = [
    ...
    function (e) {
      ...
      function p() {
        ...
        if (
          ("fraction" === s.type &&
            (r.find(W(s.currentClass)).text(s.formatFractionCurrent(p + 1)),
            r.find(W(s.totalClass)).text(s.formatFractionTotal(u))),
          "progressbar" === s.type)
        ) {
          let e
      ...
      function h() {
        ...
        0 !== s.length &&
          ...
          e.clickable &&
            s.on("click", W(e.bulletClass), function (e) {
              e.preventDefault()
      ...
      function m() {
        ...
        s.removeClass(e.hiddenClass),
          ...
          e.clickable && s.off("click", W(e.bulletClass))
      }
      a("init", () => {
    ...
    function (e) {
      ...
      function m(e) {
        ...
        t.navigation &&
          ...
          t.pagination &&
            a.is(W(t.params.pagination.bulletClass)) &&
            a[0].click()
      }
      function f() {
        return (
        ...
        U({
          ...
          setTransition: (e) => {
            ...
            ;(s ? t.slides.find(s) : t.slides).transition(e),
              Z({ swiper: t, duration: e, transformEl: s, allSlides: !0 })
          },
          overwriteParams: () => ({
            slidesPerView: 1,
            slidesPerGroup: 1,
      ...
      const i = (e, s, a) => {
        let i = t.isHorizontal()
          ...
          r = t.isHorizontal()
            ? e.find(".swiper-slide-shadow-right")
            : e.find(".swiper-slide-shadow-bottom")
        0 === i.length && (i = Q(a, e, t.isHorizontal() ? "left" : "top")),
          0 === r.length &&
            (r = Q(a, e, t.isHorizontal() ? "right" : "bottom")),
      ...
      U({
        ...
        setTransition: (e) => {
          ...
          ;(s ? t.slides.find(s) : t.slides)
            ...
            .transition(e),
            Z({ swiper: t, duration: e, transformEl: s })
        },
        recreateShadows: () => {
          ...
          setTranslate: () => {
            ...
            for (let e = 0, t = a.length; e < t; e += 1) {
              ...
              if (
                ...
                0 === e.length && (e = Q(r, t, n ? "left" : "top")),
                  0 === s.length && (s = Q(r, t, n ? "right" : "bottom")),
        ...
        setTranslate: () => {
          ...
          for (let s = 0; s < e.length; s += 1) {
            ...
            if ((m && f.shadow) || !m) {
              ...
              if ((0 === e.length && f.shadow && (e = Q(r, a)), e.length)) {
